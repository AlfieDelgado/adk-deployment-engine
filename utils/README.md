...
- **Secret Manager Integration**:
  - Local deployment with secrets: `--set-secrets` (replaces all existing secrets)
  - Local deployment without secrets: `--clear-secrets` (removes all existing secrets)
  - CI/CD mode: Preserves existing configuration (no secret flags)
